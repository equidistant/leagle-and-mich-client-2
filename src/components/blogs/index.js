...
import { useThemeBlogs } from '../../effects'


const Blogs = () => {
  const [theme] = useThemeBlogs()
  const images = [
    ...
    <Container>
      ...
      <BlogContainer>
        <BlogCenterContainer {...theme}>
          ...
          <TextHeader1 {...theme}>Četvrtak 20.6.2019.</TextHeader1>
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Jezero Bled</TextHeader2>
          ...
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Vintgar Gorges</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <ImgRow {...theme}>
            <ImgWrapPortraitLeft {...theme}>
              <ImgOverlay>Spremna za polazak!</ImgOverlay>
              <ImgPortraitHalf img={images[13]}/>
            </ImgWrapPortraitLeft>
            <ImgWrapPortrait {...theme}>
              <ImgOverlay>Čekam fotografa da me stigne...</ImgOverlay>
              <ImgPortraitHalf img={images[14]}/>
            </ImgWrapPortrait>
          </ImgRow>
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Jezero Jasna</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Jezero Zelenci</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <ImgRow {...theme}>
            <ImgWrap>
              <ImgOverlay>Mir i tisina...</ImgOverlay>
              <Img img={images[17]}/>
            </ImgWrap>
          </ImgRow>
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Vršič pass</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Kamp Vodenca</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <TextHeader1 {...theme}>Petak 21.6.2019.</TextHeader1>
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Rafting na Soči</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Slap Virje</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <TextHeader1 {...theme}>Subota 22.6.2019.</TextHeader1>
          <Text {...theme}>
          ...
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Slap Kozjak</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <ImgRow {...theme}>
            <ImgWrap>
              <ImgOverlay>Kratka ekspozicija</ImgOverlay>
              <Img img={images[5]}/>
            </ImgWrap>
          </ImgRow>
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Napoleonov most</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Slap Boka</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <TextHeader1 {...theme}>Nedjelja 23.6.2019.</TextHeader1>
          <Text {...theme}>
          ...
          <ImgRow {...theme}>
            ...
            <ImgWrapLandscape {...theme}>
              <ImgOverlay>Meni je i pod sasvim ok... Fino ravan taman</ImgOverlay>
              <ImgLandscapeHalf img={images[23]}/>
            </ImgWrapLandscape>
          </ImgRow>
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Šunikov vodni gaj</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <ImgRow {...theme}>
            <ImgWrapPortraitLeft {...theme}>
              <ImgOverlay>Ana se glupira (a meni viče da pazim jer je sklisko)</ImgOverlay>
          ...
          <TextHeader1 {...theme}>Ponedjeljak 24.6.2019.</TextHeader1>
          <Text {...theme}>
          ...
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Tolminska korita</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Ušče rijeke Tolminke u Soču</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <BulletHeaderContainer {...theme}>
            <StarBullet/><TextHeader2 {...theme}>Most na Soči + SUP</TextHeader2>
          </BulletHeaderContainer>
          <Text {...theme}>
          ...
          <TextHeader1 {...theme}>Utorak 25.6.2019.</TextHeader1>
          <Text {...theme}>
          ...
          <ImgRow {...theme}>
            ...
            <ImgWrapPortrait {...theme}>
              <ImgOverlay>Mjesto idealno za kupanac</ImgOverlay>
...
const TextHeader1 = styled.p(({ padding, margin }) => `
  padding: ${padding}rem;
  margin-top: ${margin}rem;
...
const TextHeader2 = styled.span(({ padding, margin }) => `
  padding: ${padding}rem;
