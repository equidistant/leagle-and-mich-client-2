...
const Text = styled.p(({ main: { width}, fontSize, letterSpacing, padding }) => `
  padding: ${padding};
  font-size: ${fontSize};
  letter-spacing: ${letterSpacing};
  font-family: 'Maple';
...
const StarBullet = styled.div(({ starBullet: { width, height, margin} }) => `
...
const ImgOverlay = styled.div(({ imgOverlay: { letterSpacing, fontSize, padding } }) => `
  position: absolute;
  bottom: 0;
